...
const tabs = [
  {
    ...
    label: 'Home',
    icon: (active) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#111111' : 'none'} stroke="currentColor" strokeWidth="2"><path d="M3 12a9 9 0 1 1 18 0"/><path d="M5 12a7 7 0 1 1 14 0"/><path d="M8 12a4 4 0 1 1 8 0"/><circle cx="12" cy="12" r="1.5" fill={active ? '#111111' : 'none'}/>
      </svg>
    ),
  },
  {
